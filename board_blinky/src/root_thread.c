...
/*
 * board_blinky — alternate LEDs @ 1 Hz with a small serial shell.
 *
 * Requires TC275 Lite board services (console, timer, gpio, leds).
 */
...
void ulmk_root_thread(const ulmk_boot_info_t *info)
{
	...
	board_console_puts("\n");
	board_console_puts("TC275 Lite blinky\n");
	board_console_puts("LEDs alternate @ 1 Hz. Type help for shell cmds.\n");
	board_console_puts("> ");
