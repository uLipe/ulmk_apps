...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    /*
     * tlsf pool after dual FBs — address/size come from the active board.
     */
    #include "board_config.h"
    #define LV_MEM_SIZE   ULMK_BOARD_LVGL_HEAP_SIZE
    #define LV_MEM_ADR    ULMK_BOARD_LVGL_HEAP_ADDR
